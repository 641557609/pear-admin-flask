...
Revision ID: 621bcb144a8a
Revises: 
Create Date: 2025-03-26 11:30:43.664290
...
def upgrade():
    ...
    sa.Column('job_number', sa.String(length=20), nullable=False, comment='员工工号'),
    sa.Column('name', sa.String(length=20), nullable=True, comment='员工姓名'),
    sa.Column('status', sa.Boolean(), nullable=True, comment='员工状态'),
    sa.PrimaryKeyConstraint('job_number')
    )
    op.create_table('task_template',
    sa.Column('id', sa.Integer(), nullable=False, comment='模板ID'),
    sa.Column('creator', sa.String(length=50), nullable=True, comment='创建者'),
    sa.Column('template_name', sa.String(length=60), nullable=False, comment='模板名称'),
    sa.Column('remark', sa.Text(), nullable=True, comment='备注'),
    sa.Column('sql_template', sa.Text(), nullable=False, comment='原始SQL模板'),
    sa.Column('create_time', sa.DateTime(), nullable=True, comment='创建时间'),
    sa.Column('update_time', sa.DateTime(), nullable=True, comment='更新时间'),
    sa.Column('template_type', sa.String(length=10), nullable=False, comment='任务类型'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('task_name', sa.String(length=30), nullable=False, comment='任务名称'),
    sa.Column('file_config', sa.JSON(), nullable=False, comment='文件配置'),
    sa.Column('schedule_config', sa.JSON(), nullable=False, comment='调度配置'),
    sa.Column('variables_config', sa.JSON(), nullable=False, comment='变量配置'),
    sa.Column('enable', sa.Integer(), nullable=False, comment='是否开启'),
    ...
    sa.Column('logger_id', sa.Integer(), autoincrement=True, nullable=False, comment='运行日志编号'),
    sa.Column('executed_sql', sa.Text(), nullable=True, comment='实际执行的SQL'),
    sa.Column('status', sa.String(length=10), nullable=True, comment='运行结果'),
    sa.Column('result_path', sa.String(length=256), nullable=True, comment='Excel文件存储路径'),
    sa.Column('task_name', sa.String(length=60), nullable=True, comment='任务名称'),
    sa.Column('run_time', sa.DateTime(), nullable=True, comment='运行时间'),
    sa.Column('trigger_mode', sa.String(length=10), nullable=True, comment='触发方式'),
    sa.Column('execution_time', sa.Float(), nullable=True, comment='执行耗时（秒）'),
    sa.Column('error_detail', sa.Text(), nullable=True, comment='异常堆栈信息'),
    sa.Column('task_id', sa.Integer(), nullable=True, comment='任务编号'),
    sa.ForeignKeyConstraint(['task_id'], ['scheduled_task.task_id'], ),
    sa.PrimaryKeyConstraint('logger_id')
    )
    op.create_table('task_employee',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False, comment='标识'),
    sa.Column('task_id', sa.Integer(), nullable=True, comment='任务编号'),
    sa.Column('job_number', sa.String(length=20), nullable=True, comment='员工编号'),
    sa.ForeignKeyConstraint(['job_number'], ['employees.job_number'], ),
    sa.ForeignKeyConstraint(['task_id'], ['scheduled_task.task_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
