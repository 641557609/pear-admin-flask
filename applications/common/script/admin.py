...
powerdata = [
    Power(
        ...
        name='模板管理',
        type='1',
        code='mission:template:main',
        url='/mission/template/',
        open_type='_iframe',
        parent_id='60',
        icon='',
        sort=1,
